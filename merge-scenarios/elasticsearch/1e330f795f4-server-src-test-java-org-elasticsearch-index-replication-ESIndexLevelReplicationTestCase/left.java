...
public abstract class ESIndexLevelReplicationTestCase extends IndexShardTestCase {
    ...
    protected class ReplicationGroup implements AutoCloseable, Iterable<IndexShard> {
        ...
        private final PrimaryReplicaSyncer primaryReplicaSyncer = new PrimaryReplicaSyncer(Settings.EMPTY, new TaskManager(Settings.EMPTY), (request, parentTask, primaryAllocationId, primaryTerm, listener) -> {
            try {
