...
final class Bootstrap {
    ...
    static void init(final boolean foreground, final Path pidFile, final boolean quiet, final Settings initialSettings) throws BootstrapException, NodeValidationException, UserException {
        initLoggerPrefix();
        BootstrapInfo.init();
