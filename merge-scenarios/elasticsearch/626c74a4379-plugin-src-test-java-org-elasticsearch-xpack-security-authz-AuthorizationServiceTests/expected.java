...
public class AuthorizationServiceTests extends ESTestCase {
    ...
    public void testActionsSystemUserIsAuthorized() {
        ...
        verify(auditTrail).accessGranted(SystemUser.INSTANCE, "indices:monitor/whatever", request, new String[] { SystemUser.ROLE_NAME }, null);
    ...
    public void testClusterAdminSnapshotStatusActionIsNotAuthorized() {
        ...
        verify(auditTrail).accessDenied(SystemUser.INSTANCE, "cluster:admin/snapshot/status", request, new String[] { SystemUser.ROLE_NAME }, null);
        verifyNoMoreInteractions(auditTrail);
    }
    ...
    public void testScrollRelatedRequestsAllowed() {
        ...
        verify(auditTrail).accessGranted(user, SearchTransportService.CLEAR_SCROLL_CONTEXTS_ACTION_NAME, request, new String[] { role.getName() }, null);
        authorize(createAuthentication(user), SearchTransportService.FETCH_ID_SCROLL_ACTION_NAME, request);
        verify(auditTrail).accessGranted(user, SearchTransportService.FETCH_ID_SCROLL_ACTION_NAME, request, new String[] { role.getName() }, null);
        authorize(createAuthentication(user), SearchTransportService.QUERY_FETCH_SCROLL_ACTION_NAME, request);
        verify(auditTrail).accessGranted(user, SearchTransportService.QUERY_FETCH_SCROLL_ACTION_NAME, request, new String[] { role.getName() }, null);
        authorize(createAuthentication(user), SearchTransportService.QUERY_SCROLL_ACTION_NAME, request);
        verify(auditTrail).accessGranted(user, SearchTransportService.QUERY_SCROLL_ACTION_NAME, request, new String[] { role.getName() }, null);
        authorize(createAuthentication(user), SearchTransportService.FREE_CONTEXT_SCROLL_ACTION_NAME, request);
        verify(auditTrail).accessGranted(user, SearchTransportService.FREE_CONTEXT_SCROLL_ACTION_NAME, request, new String[] { role.getName() }, null);
        verifyNoMoreInteractions(auditTrail);
    }
    ...
    public void testNonXPackUserCannotExecuteOperationAgainstSecurityIndex() {
        ...
        try (StoredContext context = threadContext.stashContext()) {
            ...
            verify(auditTrail).accessDenied(user, SqlAction.NAME, request, new String[] { role.getName() }, singleton(SecurityLifecycleService.SECURITY_INDEX_NAME));
            verifyNoMoreInteractions(auditTrail);
        }
    ...
    public void testAuthorizationOfIndividualBulkItems() {
        ...
        mockEmptyMetaData();
        authorize(createAuthentication(user), action, request);
        verify(auditTrail).accessDenied(user, DeleteAction.NAME, request, new String[] { role.getName() }, null);
        verify(auditTrail).accessDenied(user, IndexAction.NAME, request, new String[] { role.getName() }, null);
        verify(auditTrail).accessGranted(user, action, request, new String[] { role.getName() }, null);
        verifyNoMoreInteractions(auditTrail);
    }
    ...
    public void testAuthorizationOfIndividualBulkItemsWithDateMath() {
        ...
        mockEmptyMetaData();
        authorize(createAuthentication(user), action, request);
        verify(auditTrail, Mockito.times(2)).accessDenied(user, DeleteAction.NAME, request, new String[] { role.getName() }, null);
        verify(auditTrail).accessGranted(user, action, request, new String[] { role.getName() }, null);
        verifyNoMoreInteractions(auditTrail);
    }
