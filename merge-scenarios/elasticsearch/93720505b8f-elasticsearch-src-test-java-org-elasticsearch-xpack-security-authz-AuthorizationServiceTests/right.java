...
public class AuthorizationServiceTests extends ESTestCase {
    ...
    public void testSameUserPermission() {
        ...
        when(authenticatedBy.getType()).thenReturn(changePasswordRequest ? randomFrom(ReservedRealm.TYPE, NativeRealm.TYPE) : randomAsciiOfLengthBetween(4, 12));
    ...
    public void testSameUserPermissionDoesNotAllowNonMatchingUsername() {
        ...
        when(lookedUpBy.getType()).thenReturn(changePasswordRequest ? randomFrom(ReservedRealm.TYPE, NativeRealm.TYPE) : randomAsciiOfLengthBetween(4, 12));
        assertFalse(AuthorizationService.checkSameUserPermissions(action, request, authentication));
    ...
    public void testSameUserPermissionDoesNotAllowOtherActions() {
        ...
        when(authentication.getAuthenticatedBy()).thenReturn(authenticatedBy);
        when(authenticatedBy.getType()).thenReturn(randomAsciiOfLengthBetween(4, 12));
        assertFalse(AuthorizationService.checkSameUserPermissions(action, request, authentication));
    ...
    public void testSameUserPermissionDoesNotAllowChangePasswordForOtherRealms() {
        ...
        when(authentication.getAuthenticatedBy()).thenReturn(authenticatedBy);
        when(authenticatedBy.getType()).thenReturn(randomFrom(LdapRealm.LDAP_TYPE, FileRealm.TYPE, LdapRealm.AD_TYPE, PkiRealm.TYPE, randomAsciiOfLengthBetween(4, 12)));
        assertThat(request, instanceOf(UserRequest.class));
        assertFalse(AuthorizationService.checkSameUserPermissions(action, request, authentication));
    ...
    public void testSameUserPermissionDoesNotAllowChangePasswordForLookedUpByOtherRealms() {
        ...
        when(authentication.getAuthenticatedBy()).thenReturn(authenticatedBy);
        when(authentication.getLookedUpBy()).thenReturn(lookedUpBy);
        when(lookedUpBy.getType()).thenReturn(randomFrom(LdapRealm.LDAP_TYPE, FileRealm.TYPE, LdapRealm.AD_TYPE, PkiRealm.TYPE, randomAsciiOfLengthBetween(4, 12)));
        assertThat(request, instanceOf(UserRequest.class));
        assertFalse(AuthorizationService.checkSameUserPermissions(action, request, authentication));
