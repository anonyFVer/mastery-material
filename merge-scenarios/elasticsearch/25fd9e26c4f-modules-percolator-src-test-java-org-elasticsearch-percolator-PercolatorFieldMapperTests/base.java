...
public class PercolatorFieldMapperTests extends ESSingleNodeTestCase {
    ...
    public void init() throws Exception {
        ...
        String mapper = XContentFactory.jsonBuilder().startObject().startObject("type").startObject("_field_names").field("enabled", false).endObject().startObject("properties").startObject("field").field("type", "text").endObject().startObject("number_field").field("type", "long").endObject().startObject("date_field").field("type", "date").endObject().endObject().endObject().endObject().string();
    ...
    public void testNestedPercolatorField() throws Exception {
        ...
        assertThat(doc.rootDoc().getFields().size(), equalTo(8));
