...
public class TransportBroadcastByNodeActionTests extends ESTestCase {
    ...
    public void setUp() throws Exception {
        ...
        TransportService transportService = transport.createCapturingTransportService(clusterService.getSettings(), THREAD_POOL, TransportService.NOOP_TRANSPORT_INTERCEPTOR, x -> clusterService.localNode(), null, Collections.emptySet());
