...
public final class Script implements ToXContentObject, Writeable {
    ...
    private static final class Builder {
        ...
        private Script build(String defaultLang) {
            if (type == null) {
                throw new IllegalArgumentException("must specify either code for an [" + ScriptType.INLINE.getParseField().getPreferredName() + "] script " + "or an id for a [" + ScriptType.STORED.getParseField().getPreferredName() + "] script");
            }
