...
public class MembershipActionTests extends ESTestCase {
    ...
    public void testPreventJoinClusterWithNewerIndices() {
        ...
        expectThrows(IllegalStateException.class, () -> MembershipAction.ensureIndexCompatibility(VersionUtils.getPreviousVersion(Version.CURRENT), metaData));
    }
    ...
    public void testPreventJoinClusterWithUnsupportedIndices() {
        ...
        metaBuilder.put(indexMetaData, false);
        MetaData metaData = metaBuilder.build();
        expectThrows(IllegalStateException.class, () -> MembershipAction.ensureIndexCompatibility(Version.CURRENT, metaData));
    }
