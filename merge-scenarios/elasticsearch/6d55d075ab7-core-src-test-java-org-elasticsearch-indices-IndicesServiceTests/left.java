...
public class IndicesServiceTests extends ESSingleNodeTestCase {
    ...
    public static class TestPlugin extends Plugin implements MapperPlugin {
        ...
        public void onIndexModule(IndexModule indexModule) {
            ...
            indexModule.addSimilarity("fake-similarity", (name, settings, indexSettings, scriptService) -> new BM25SimilarityProvider(name, settings, indexSettings));
        }
    }
    ...
    public void testConflictingEngineFactories() throws IOException {
        ...
        final String pattern = ".*multiple plugins provided engine factories for \\[foobar/.*\\]: " + "\\[.*FooEnginePlugin/.*FooEngineFactory\\],\\[.*BarEnginePlugin/.*BarEngineFactory\\].*";
