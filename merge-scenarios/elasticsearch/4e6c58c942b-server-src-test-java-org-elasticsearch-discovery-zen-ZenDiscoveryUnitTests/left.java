...
public class ZenDiscoveryUnitTests extends ESTestCase {
    ...
    public void testNotEnoughMasterNodesAfterRemove() throws Exception {
        ...
        final ZenNodeRemovalClusterStateTaskExecutor executor = new ZenNodeRemovalClusterStateTaskExecutor(allocationService, electMasterService, submitRejoin, logger) {
