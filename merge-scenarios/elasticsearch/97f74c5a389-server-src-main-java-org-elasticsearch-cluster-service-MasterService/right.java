...
public class MasterService extends AbstractLifecycleComponent {
    ...
    protected synchronized void doStart() {
        ...
        threadPoolExecutor = EsExecutors.newSinglePrioritizing(nodeName + "/" + MASTER_UPDATE_THREAD_NAME, daemonThreadFactory(settings, MASTER_UPDATE_THREAD_NAME), threadPool.getThreadContext(), threadPool.scheduler());
