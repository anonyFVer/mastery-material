...
public class TransportWriteActionTests extends ESTestCase {
    ...
    public void testReplicaProxy() throws InterruptedException, ExecutionException {
        ...
        proxy.performOn(TestShardRouting.newShardRouting(shardId, "NOT THERE", routingState == ShardRoutingState.RELOCATING ? state.nodes().iterator().next().getId() : null, false, routingState), new TestRequest(), randomNonNegativeLong(), listener);
