...
public class RelocationIT extends ESIntegTestCase {
    ...
    public void testRelocationWhileIndexingRandom() throws Exception {
        ...
        logger.info("--> creating test index ...");
        client().admin().indices().prepareCreate("test").setSettings(Settings.builder().put("index.number_of_shards", 1).put("index.number_of_replicas", numberOfReplicas)).execute().actionGet();
