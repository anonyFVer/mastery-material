...
public abstract class TransportReplicationAction<Request extends ReplicationRequest<Request>, ReplicaRequest extends ReplicationRequest<ReplicaRequest>, Response extends ReplicationResponse> extends TransportAction<Request, Response> {
    ...
    public class ReplicaOperationTransportHandler implements TransportRequestHandler<ConcreteReplicaRequest<ReplicaRequest>> {
        ...
        public void messageReceived(final ConcreteReplicaRequest<ReplicaRequest> replicaRequest, final TransportChannel channel, final Task task) throws Exception {
            new AsyncReplicaAction(replicaRequest.getRequest(), replicaRequest.getTargetAllocationID(), replicaRequest.getPrimaryTerm(), replicaRequest.getGlobalCheckpoint(), channel, (ReplicationTask) task).run();
        }
    }
    ...
    private final class AsyncReplicaAction extends AbstractRunnable implements ActionListener<Releasable> {
        ...
        AsyncReplicaAction(ReplicaRequest request, String targetAllocationID, long primaryTerm, long globalCheckpoint, TransportChannel channel, ReplicationTask task) {
            this.request = request;
            this.channel = channel;
            this.task = task;
            this.targetAllocationID = targetAllocationID;
            ...
            if (e instanceof RetryOnReplicaException) {
                ...
                observer.waitForNextChange(new ClusterStateObserver.Listener() {
                    ...
                    public void onNewClusterState(ClusterState state) {
                        ...
                        transportService.sendRequest(clusterService.localNode(), transportReplicaAction, new ConcreteReplicaRequest<>(request, targetAllocationID, primaryTerm, globalCheckpoint), handler);
                    }
    ...
    protected class ReplicasProxy implements ReplicationOperation.Replicas<ReplicaRequest> {
        ...
        @Override
        public void performOn(final ShardRouting replica, final ReplicaRequest request, final long globalCheckpoint, final ActionListener<ReplicationOperation.ReplicaResponse> listener) {
            ...
            final ConcreteReplicaRequest<ReplicaRequest> replicaRequest = new ConcreteReplicaRequest<>(request, replica.allocationId().getId(), primaryTerm, globalCheckpoint);
    ...
    protected static final class ConcreteReplicaRequest<R extends TransportRequest> extends ConcreteShardRequest<R> {
        ...
        public ConcreteReplicaRequest(final R request, final String targetAllocationID, final long primaryTerm, final long globalCheckpoint) {
        ...
        @Override
        public String toString() {
            return "ConcreteReplicaRequest{" + "targetAllocationID='" + getTargetAllocationID() + '\'' + ", primaryTerm='" + getPrimaryTerm() + '\'' + ", request=" + getRequest() + ", globalCheckpoint=" + globalCheckpoint + '}';
        }
    }
