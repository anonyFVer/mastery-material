...
public class RecoveryTests extends ESIndexLevelReplicationTestCase {
    ...
    public void testRecoveryWithOutOfOrderDelete() throws Exception {
        Settings settings = Settings.builder().put(IndexSettings.INDEX_SOFT_DELETES_RETENTION_OPERATIONS_SETTING.getKey(), 10).put(MergePolicyConfig.INDEX_MERGE_ENABLED, false).build();
