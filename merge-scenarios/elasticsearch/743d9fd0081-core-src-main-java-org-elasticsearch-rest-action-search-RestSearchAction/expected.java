...
public class RestSearchAction extends BaseRestHandler {
    ...
    public static void parseSearchRequest(SearchRequest searchRequest, RestRequest request, SearchRequestParsers searchRequestParsers, ParseFieldMatcher parseFieldMatcher, BytesReference restContent) throws IOException {
