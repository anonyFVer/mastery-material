...
final class RequestConverters {
    ...
    static Request getFieldMapping(GetFieldMappingsRequest getFieldMappingsRequest) throws IOException {
        ...
        String endpoint = new EndpointBuilder().addCommaSeparatedPathParts(indices).addPathPartAsIs("_mapping").addCommaSeparatedPathParts(types).addPathPartAsIs("field").addCommaSeparatedPathParts(fields).build();
    ...
    static Request explain(ExplainRequest explainRequest) throws IOException {
        Request request = new Request(HttpGet.METHOD_NAME, endpoint(explainRequest.index(), explainRequest.type(), explainRequest.id(), "_explain"));
        Params params = new Params(request);
    ...
    static Request getPipeline(GetPipelineRequest getPipelineRequest) {
        String endpoint = new EndpointBuilder().addPathPartAsIs("_ingest/pipeline").addCommaSeparatedPathParts(getPipelineRequest.getIds()).build();
        Request request = new Request(HttpGet.METHOD_NAME, endpoint);
        Params parameters = new Params(request);
    ...
    static Request putPipeline(PutPipelineRequest putPipelineRequest) throws IOException {
        String endpoint = new EndpointBuilder().addPathPartAsIs("_ingest/pipeline").addPathPart(putPipelineRequest.getId()).build();
        Request request = new Request(HttpPut.METHOD_NAME, endpoint);
        Params parameters = new Params(request);
    ...
    static Request deletePipeline(DeletePipelineRequest deletePipelineRequest) {
        String endpoint = new EndpointBuilder().addPathPartAsIs("_ingest/pipeline").addPathPart(deletePipelineRequest.getId()).build();
        Request request = new Request(HttpDelete.METHOD_NAME, endpoint);
        Params parameters = new Params(request);
    ...
    static Request reindex(ReindexRequest reindexRequest) throws IOException {
        ...
        Request request = new Request(HttpPost.METHOD_NAME, endpoint);
        Params params = new Params(request).withRefresh(reindexRequest.isRefresh()).withTimeout(reindexRequest.getTimeout()).withWaitForActiveShards(reindexRequest.getWaitForActiveShards());
    ...
    static Request deleteByQuery(DeleteByQueryRequest deleteByQueryRequest) throws IOException {
        ...
        Request request = new Request(HttpPost.METHOD_NAME, endpoint);
        Params params = new Params(request).withRouting(deleteByQueryRequest.getRouting()).withRefresh(deleteByQueryRequest.isRefresh()).withTimeout(deleteByQueryRequest.getTimeout()).withWaitForActiveShards(deleteByQueryRequest.getWaitForActiveShards()).withIndicesOptions(deleteByQueryRequest.indicesOptions());
    ...
    static Request verifyRepository(VerifyRepositoryRequest verifyRepositoryRequest) {
        String endpoint = new EndpointBuilder().addPathPartAsIs("_snapshot").addPathPart(verifyRepositoryRequest.name()).addPathPartAsIs("_verify").build();
        Request request = new Request(HttpPost.METHOD_NAME, endpoint);
        Params parameters = new Params(request);
    ...
    static Request createSnapshot(CreateSnapshotRequest createSnapshotRequest) throws IOException {
        String endpoint = new EndpointBuilder().addPathPart("_snapshot").addPathPart(createSnapshotRequest.repository()).addPathPart(createSnapshotRequest.snapshot()).build();
        Request request = new Request(HttpPut.METHOD_NAME, endpoint);
        Params params = new Params(request);
    ...
    static Request getSnapshots(GetSnapshotsRequest getSnapshotsRequest) {
        EndpointBuilder endpointBuilder = new EndpointBuilder().addPathPartAsIs("_snapshot").addPathPart(getSnapshotsRequest.repository());
        String endpoint;
    ...
    static Request snapshotsStatus(SnapshotsStatusRequest snapshotsStatusRequest) {
        String endpoint = new EndpointBuilder().addPathPartAsIs("_snapshot").addPathPart(snapshotsStatusRequest.repository()).addCommaSeparatedPathParts(snapshotsStatusRequest.snapshots()).addPathPartAsIs("_status").build();
        Request request = new Request(HttpGet.METHOD_NAME, endpoint);
        Params parameters = new Params(request);
    ...
    static Request restoreSnapshot(RestoreSnapshotRequest restoreSnapshotRequest) throws IOException {
        String endpoint = new EndpointBuilder().addPathPartAsIs("_snapshot").addPathPart(restoreSnapshotRequest.repository()).addPathPart(restoreSnapshotRequest.snapshot()).addPathPartAsIs("_restore").build();
        Request request = new Request(HttpPost.METHOD_NAME, endpoint);
        Params parameters = new Params(request);
    ...
    static Request deleteSnapshot(DeleteSnapshotRequest deleteSnapshotRequest) {
        String endpoint = new EndpointBuilder().addPathPartAsIs("_snapshot").addPathPart(deleteSnapshotRequest.repository()).addPathPart(deleteSnapshotRequest.snapshot()).build();
        Request request = new Request(HttpDelete.METHOD_NAME, endpoint);
        Params parameters = new Params(request);
    ...
    static Request putLifecyclePolicy(PutLifecyclePolicyRequest putLifecycleRequest) throws IOException {
        String endpoint = new EndpointBuilder().addPathPartAsIs("_ilm").addPathPartAsIs(putLifecycleRequest.getName()).build();
        Request request = new Request(HttpPut.METHOD_NAME, endpoint);
        Params params = new Params(request);
    ...
    static Request deleteLifecyclePolicy(DeleteLifecyclePolicyRequest deleteLifecyclePolicyRequest) {
        Request request = new Request(HttpDelete.METHOD_NAME, new EndpointBuilder().addPathPartAsIs("_ilm").addPathPartAsIs(deleteLifecyclePolicyRequest.getLifecyclePolicy()).build());
        Params params = new Params(request);
    ...
    static Request setIndexLifecyclePolicy(SetIndexLifecyclePolicyRequest setPolicyRequest) {
        ...
        Request request = new Request(HttpPut.METHOD_NAME, new EndpointBuilder().addCommaSeparatedPathParts(indices).addPathPartAsIs("_ilm").addPathPart(setPolicyRequest.policy()).build());
        Params params = new Params(request);
    ...
    static Request startILM(StartILMRequest startILMRequest) {
        Request request = new Request(HttpPost.METHOD_NAME, new EndpointBuilder().addPathPartAsIs("_ilm").addPathPartAsIs("start").build());
        Params params = new Params(request);
    ...
    static Request stopILM(StopILMRequest stopILMRequest) {
        Request request = new Request(HttpPost.METHOD_NAME, new EndpointBuilder().addPathPartAsIs("_ilm").addPathPartAsIs("stop").build());
        Params params = new Params(request);
    ...
    static Request explainLifecycle(ExplainLifecycleRequest explainLifecycleRequest) {
        ...
        Request request = new Request(HttpGet.METHOD_NAME, new EndpointBuilder().addCommaSeparatedPathParts(indices).addPathPartAsIs("_ilm").addPathPartAsIs("explain").build());
        Params params = new Params(request);
    ...
    static Request putLicense(PutLicenseRequest putLicenseRequest) {
        String endpoint = new EndpointBuilder().addPathPartAsIs("_xpack").addPathPartAsIs("license").build();
        Request request = new Request(HttpPut.METHOD_NAME, endpoint);
        Params parameters = new Params(request);
    ...
    static Request getMigrationAssistance(IndexUpgradeInfoRequest indexUpgradeInfoRequest) {
        EndpointBuilder endpointBuilder = new EndpointBuilder().addPathPartAsIs("_xpack/migration/assistance").addCommaSeparatedPathParts(indexUpgradeInfoRequest.indices());
