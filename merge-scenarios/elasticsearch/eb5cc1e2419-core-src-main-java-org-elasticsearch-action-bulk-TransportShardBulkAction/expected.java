    ...
    private UpdateResultHolder executeUpdateRequest(UpdateRequest updateRequest, IndexShard primary, IndexMetaData metaData, BulkShardRequest request, int requestIndex) throws Exception {
        ...
        for (int attemptCount = 0; attemptCount <= maxAttempts; attemptCount++) {
            ...
            if (updateOperationResult == null) {
                ...
                assert (replicaRequest.request() instanceof IndexRequest && ((IndexRequest) replicaRequest.request()).getSeqNo() != SequenceNumbersService.UNASSIGNED_SEQ_NO) || (replicaRequest.request() instanceof DeleteRequest && ((DeleteRequest) replicaRequest.request()).getSeqNo() != SequenceNumbersService.UNASSIGNED_SEQ_NO);
                break;
