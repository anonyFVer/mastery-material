...
public class RefreshListenersTests extends ESTestCase {
    ...
    public void setupListeners() throws Exception {
        ...
        listeners = new RefreshListeners(() -> maxListeners, () -> engine.refresh("too-many-listeners"), Runnable::run, logger, threadPool.getThreadContext());
    ...
    public void testClose() throws Exception {
        ...
        {
            DummyRefreshListener listener = new DummyRefreshListener();
            Exception e = expectThrows(IllegalStateException.class, () -> listeners.addOrNotify(unrefreshedOperation.getTranslogLocation(), listener));
