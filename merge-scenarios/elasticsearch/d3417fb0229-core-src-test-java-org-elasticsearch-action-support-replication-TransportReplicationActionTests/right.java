...
public class TransportReplicationActionTests extends ESTestCase {
    ...
    public void testRetryOnReplica() throws Exception {
        ...
        final TransportReplicationAction.ConcreteShardRequest<Request> concreteShardRequest = (TransportReplicationAction.ConcreteShardRequest<Request>) capturedRequest.request;
        ...
        assertThat(concreteShardRequest.getTargetAllocationID(), equalTo(replica.allocationId().getId()));
    }
