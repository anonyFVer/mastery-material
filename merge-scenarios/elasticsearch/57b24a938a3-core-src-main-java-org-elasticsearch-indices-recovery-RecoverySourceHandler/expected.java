...
public class RecoverySourceHandler {
    ...
    public RecoveryResponse recoverToTarget() throws IOException {
        ...
        try (Closeable ignored = shard.acquireTranslogRetentionLock()) {
            ...
            final boolean isSequenceNumberBasedRecoveryPossible = request.startingSeqNo() != SequenceNumbers.UNASSIGNED_SEQ_NO && isTargetSameHistory() && isTranslogReadyForSequenceNumberBasedRecovery();
    ...
    protected SendSnapshotResult sendSnapshot(final long startingSeqNo, final Translog.Snapshot snapshot) throws IOException {
        ...
        assert expectedTotalOps == skippedOps + totalSentOps : "expected total [" + expectedTotalOps + "], skipped [" + skippedOps + "], total sent [" + totalSentOps + "]";
