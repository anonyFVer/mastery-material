...
public class SecurityDocumentationIT extends ESRestHighLevelClientTestCase {
    ...
    public void testGetBuiltinPrivileges() throws Exception {
        ...
        }
        {
            ...
            listener = future;
            client.security().getBuiltinPrivilegesAsync(RequestOptions.DEFAULT, listener);
    ...
    public void testGetPrivileges() throws Exception {
        ...
        }
        {
            ...
            final GetPrivilegesResponse expectedResponse = new GetPrivilegesResponse(Arrays.asList(readTestappPrivilege, writeTestappPrivilege, allTestappPrivilege));
    ...
    public void testInvalidateApiKey() throws Exception {
        ...
        }
        {
            ...
            InvalidateApiKeyRequest invalidateApiKeyRequest = InvalidateApiKeyRequest.usingApiKeyName(createApiKeyResponse2.getName(), false);
            InvalidateApiKeyResponse invalidateApiKeyResponse = client.security().invalidateApiKey(invalidateApiKeyRequest, RequestOptions.DEFAULT);
            final List<ElasticsearchException> errors = invalidateApiKeyResponse.getErrors();
            final List<String> invalidatedApiKeyIds = invalidateApiKeyResponse.getInvalidatedApiKeys();
            final List<String> previouslyInvalidatedApiKeyIds = invalidateApiKeyResponse.getPreviouslyInvalidatedApiKeys();
    ...
    public void testDelegatePkiAuthentication() throws Exception {
        ...
        {
            DelegatePkiAuthenticationRequest request = new DelegatePkiAuthenticationRequest(Arrays.asList(clientCertificate, intermediateCA));
        ...
        }
        {
            ...
            listener = future;
            client.security().delegatePkiAuthenticationAsync(request, RequestOptions.DEFAULT, listener);
