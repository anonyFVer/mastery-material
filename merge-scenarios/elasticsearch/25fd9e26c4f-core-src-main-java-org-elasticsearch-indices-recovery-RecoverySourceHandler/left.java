...
public class RecoverySourceHandler {
    ...
    public RecoverySourceHandler(final IndexShard shard, RecoveryTargetHandler recoveryTarget, final StartRecoveryRequest request, final int fileChunkSizeInBytes, final ESLogger logger) {
        this.shard = shard;
            ...
            if (recoverWithSyncId) {
                ...
                try {
                    ...
                    if ((corruptIndexException = ExceptionsHelper.unwrapCorruption(targetException)) != null) {
                        ...
                        logger.warn("{} Remote file corruption during finalization of recovery on node {}. local checksum OK", corruptIndexException, shard.shardId(), request.targetNode());
                        throw exception;
                    } else {
                        throw targetException;
                    }
