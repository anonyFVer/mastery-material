            ...
            if (updateOperationResult == null) {
                ...
                switch(updateOperationResult.getOperationType()) {
                    case INDEX:
                        ...
                        final IndexResponse indexResponse = new IndexResponse(primary.shardId(), updateIndexRequest.type(), updateIndexRequest.id(), updateOperationResult.getVersion(), ((Engine.IndexResult) updateOperationResult).isCreated());
