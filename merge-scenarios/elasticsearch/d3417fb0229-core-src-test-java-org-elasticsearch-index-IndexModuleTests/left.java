...
public class IndexModuleTests extends ESTestCase {
    ...
    public void testWrapperIsBound() throws IOException {
        ...
        IndexService indexService = module.newIndexService(nodeEnvironment, deleter, nodeServicesProvider, indicesQueryCache, mapperRegistry, shardId -> {
    ...
    public void testListener() throws IOException {
        ...
        IndexModule module = new IndexModule(IndexSettingsModule.newIndexSettings(index, settings, booleanSetting), null, new AnalysisRegistry(environment, emptyMap(), emptyMap(), emptyMap(), emptyMap()));
    ...
    public void testAddIndexOperationListener() throws IOException {
        IndexModule module = new IndexModule(IndexSettingsModule.newIndexSettings(index, settings), null, new AnalysisRegistry(environment, emptyMap(), emptyMap(), emptyMap(), emptyMap()));
    ...
    public void testSetupUnknownSimilarity() throws IOException {
        ...
        IndexModule module = new IndexModule(IndexSettingsModule.newIndexSettings("foo", indexSettings), null, new AnalysisRegistry(environment, emptyMap(), emptyMap(), emptyMap(), emptyMap()));
        try {
            module.newIndexService(nodeEnvironment, deleter, nodeServicesProvider, indicesQueryCache, mapperRegistry, shardId -> {
            }, new IndicesFieldDataCache(settings, listener));
        } catch (IllegalArgumentException ex) {
