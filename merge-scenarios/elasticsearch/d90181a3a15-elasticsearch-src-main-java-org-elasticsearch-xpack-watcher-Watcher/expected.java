...
public class Watcher implements ActionPlugin, ScriptPlugin {
    ...
    public Collection<Object> createComponents(Clock clock, ScriptService scriptService, InternalClient internalClient, XPackLicenseState licenseState, HttpClient httpClient, HttpRequestTemplate.Parser httpTemplateParser, ThreadPool threadPool, ClusterService clusterService, CryptoService cryptoService, NamedXContentRegistry xContentRegistry, Collection<Object> components) {
        if (enabled == false) {
        ...
        inputFactories.put(SearchInput.TYPE, new SearchInputFactory(settings, internalClient, xContentRegistry, scriptService));
        ...
        final WatcherSearchTemplateService watcherSearchTemplateService = new WatcherSearchTemplateService(settings, scriptService, xContentRegistry);
