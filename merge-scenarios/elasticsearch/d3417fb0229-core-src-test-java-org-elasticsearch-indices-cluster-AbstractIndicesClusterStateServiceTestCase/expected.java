...
public abstract class AbstractIndicesClusterStateServiceTestCase extends ESTestCase {
    ...
    protected class MockIndicesService implements AllocatedIndices<MockIndexShard, MockIndexService> {
        ...
        @Override
        public synchronized MockIndexService createIndex(IndexMetaData indexMetaData, List<IndexEventListener> buildInIndexListener, Consumer<ShardId> globalCheckPointSyncer) throws IOException {
