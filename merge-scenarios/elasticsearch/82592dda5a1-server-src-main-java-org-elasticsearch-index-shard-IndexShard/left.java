...
public class IndexShard extends AbstractIndexShardComponent implements IndicesClusterStateService.Shard {
    ...
    public void addGlobalCheckpointListener(final long currentGlobalCheckpoint, final GlobalCheckpointListeners.GlobalCheckpointListener listener) {
    ...
    public void acquireReplicaOperationPermit(final long opPrimaryTerm, final long globalCheckpoint, final ActionListener<Releasable> onPermitAcquired, final String executorOnDelay, final Object debugInfo) {
        verifyNotClosed();
                ...
                if (opPrimaryTerm > pendingPrimaryTerm) {
                    ...
                    if (opPrimaryTerm > pendingPrimaryTerm) {
                        bumpPrimaryTerm(opPrimaryTerm, () -> {
                            ...
                            logger.trace("detected new primary with primary term [{}], resetting local checkpoint from [{}] to [{}]", opPrimaryTerm, getLocalCheckpoint(), localCheckpoint);
