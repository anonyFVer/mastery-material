...
public class GetSettingsActionTests extends ESTestCase {
    ...
    class TestTransportGetSettingsAction extends TransportGetSettingsAction {
        ...
        TestTransportGetSettingsAction() {
            super(GetSettingsActionTests.this.transportService, GetSettingsActionTests.this.clusterService, GetSettingsActionTests.this.threadPool, settingsFilter, new ActionFilters(Collections.emptySet()), new Resolver(), IndexScopedSettings.DEFAULT_SCOPED_SETTINGS);
        }
