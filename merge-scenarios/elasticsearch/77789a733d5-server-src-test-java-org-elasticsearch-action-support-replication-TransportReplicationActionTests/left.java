...
public class TransportReplicationActionTests extends ESTestCase {
    ...
    public void testRetryOnReplicaWithRealTransport() throws Exception {
        ...
        final Transport transport = new MockTcpTransport(Settings.EMPTY, threadPool, BigArrays.NON_RECYCLING_INSTANCE, new NoneCircuitBreakerService(), namedWriteableRegistry, new NetworkService(Collections.emptyList()), Version.CURRENT);
