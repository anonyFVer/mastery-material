                ...
                if (newPrimaryTerm != primaryTerm) {
                    ...
                    indexShardOperationPermits.asyncBlockOperations(30, TimeUnit.MINUTES, () -> {
                        ...
                        try {
                            ...
                            engine.seqNoService().updateLocalCheckpointForShard(currentRouting.allocationId().getId(), getEngine().seqNoService().getLocalCheckpoint());
