...
public final class IndexScopedSettings extends AbstractScopedSettings {
    ...
    }, Property.IndexScope), Setting.groupSetting("index.analysis.", Property.IndexScope))));
