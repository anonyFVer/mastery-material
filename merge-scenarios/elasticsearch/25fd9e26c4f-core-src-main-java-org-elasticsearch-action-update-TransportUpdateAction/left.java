            ...
            case UPSERT:
                ...
                indexAction.execute(upsertRequest, new ActionListener<IndexResponse>() {
                    ...
                    public void onResponse(IndexResponse response) {
                        UpdateResponse update = new UpdateResponse(response.getShardInfo(), response.getShardId(), response.getType(), response.getId(), response.getSeqNo(), response.getVersion(), response.isCreated());
            ...
            case DELETE:
                ...
                deleteAction.execute(deleteRequest, new ActionListener<DeleteResponse>() {
                    ...
                    public void onResponse(DeleteResponse response) {
                        UpdateResponse update = new UpdateResponse(response.getShardInfo(), response.getShardId(), response.getType(), response.getId(), response.getSeqNo(), response.getVersion(), false);
