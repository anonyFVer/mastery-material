...
public class GetIndexActionTests extends ESSingleNodeTestCase {
    ...
    class TestTransportGetIndexAction extends TransportGetIndexAction {
        ...
        TestTransportGetIndexAction() {
            super(GetIndexActionTests.this.transportService, GetIndexActionTests.this.clusterService, GetIndexActionTests.this.threadPool, settingsFilter, new ActionFilters(emptySet()), new GetIndexActionTests.Resolver(), indicesService, IndexScopedSettings.DEFAULT_SCOPED_SETTINGS);
        }
