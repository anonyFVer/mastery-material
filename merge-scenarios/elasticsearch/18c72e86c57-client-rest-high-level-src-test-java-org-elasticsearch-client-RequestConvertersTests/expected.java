...
public class RequestConvertersTests extends ESTestCase {
    ...
    public void testGlobalPipelineOnBulkRequest() throws IOException {
        ...
        bulkRequest.add(new IndexRequest("test", "doc", "11").source(XContentType.JSON, "field", "bulk1"));
        bulkRequest.add(new IndexRequest("test", "doc", "12").source(XContentType.JSON, "field", "bulk2"));
        bulkRequest.add(new IndexRequest("test", "doc", "13").source(XContentType.JSON, "field", "bulk3"));
        Request request = RequestConverters.bulk(bulkRequest);
    ...
    static void setRandomTimeout(TimedRequest request, TimeValue defaultTimeout, Map<String, String> expectedParams) {
        setRandomTimeout(s -> request.setTimeout(TimeValue.parseTimeValue(s, request.getClass().getName() + ".timeout")), defaultTimeout, expectedParams);
    }
    ...
    static void setRandomMasterTimeout(TimedRequest request, Map<String, String> expectedParams) {
        setRandomMasterTimeout(s -> request.setMasterTimeout(TimeValue.parseTimeValue(s, request.getClass().getName() + ".masterNodeTimeout")), expectedParams);
    }
