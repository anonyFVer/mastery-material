...
public class DynamicMappingDisabledTests extends ESSingleNodeTestCase {
    ...
    public void setUp() throws Exception {
        ...
        TransportBulkAction bulkAction = new TransportBulkAction(settings, THREAD_POOL, transportService, clusterService, null, shardBulkAction, null, actionFilters, indexNameExpressionResolver, autoCreateIndex, System::currentTimeMillis);
