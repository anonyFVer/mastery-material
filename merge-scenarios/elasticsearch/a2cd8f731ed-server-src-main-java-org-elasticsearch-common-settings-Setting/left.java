...
public class Setting<T> implements ToXContentObject {
    ...
    static AbstractScopedSettings.SettingUpdater<Settings> groupedSettingsUpdater(Consumer<Settings> consumer, Logger logger, final List<? extends Setting<?>> configuredSettings) {
    ...
    public static class AffixSetting<T> extends Setting<T> {
        ...
        AbstractScopedSettings.SettingUpdater<Map<String, T>> newAffixMapUpdater(Consumer<Map<String, T>> consumer, Logger logger, BiConsumer<String, T> validator, boolean omitDefaults) {
    ...
    private static class ListSetting<T> extends Setting<List<T>> {
        ...
        private ListSetting(String key, Function<Settings, List<String>> defaultStringValue, Function<String, List<T>> parser, Property... properties) {
            super(new ListKey(key), (s) -> Setting.arrayToParsableString(defaultStringValue.apply(s)), parser, properties);
