...
public abstract class AbstractIndicesClusterStateServiceTestCase extends ESTestCase {
    ...
    protected class MockIndicesService implements AllocatedIndices<MockIndexShard, MockIndexService> {
        ...
        @Override
        public synchronized MockIndexService createIndex(NodeServicesProvider nodeServicesProvider, IndexMetaData indexMetaData, List<IndexEventListener> buildInIndexListener) throws IOException {
