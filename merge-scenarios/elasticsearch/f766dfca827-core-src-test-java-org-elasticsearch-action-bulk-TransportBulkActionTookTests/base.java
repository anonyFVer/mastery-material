...
public class TransportBulkActionTookTests extends ESTestCase {
    ...
    private TransportBulkAction createAction(boolean controlled, AtomicLong expected) {
        ...
        TransportService transportService = new TransportService(clusterService.getSettings(), capturingTransport, threadPool, TransportService.NOOP_TRANSPORT_INTERCEPTOR, null);
    ...
    static class TestTransportBulkAction extends TransportBulkAction {
        ...
        public TestTransportBulkAction(Settings settings, ThreadPool threadPool, TransportService transportService, ClusterService clusterService, TransportShardBulkAction shardBulkAction, TransportCreateIndexAction createIndexAction, ActionFilters actionFilters, IndexNameExpressionResolver indexNameExpressionResolver, AutoCreateIndex autoCreateIndex, LongSupplier relativeTimeProvider) {
            super(settings, threadPool, transportService, clusterService, shardBulkAction, createIndexAction, actionFilters, indexNameExpressionResolver, autoCreateIndex, relativeTimeProvider);
        }
    ...
    static class TestTransportCreateIndexAction extends TransportCreateIndexAction {
        ...
        public TestTransportCreateIndexAction(Settings settings, TransportService transportService, ClusterService clusterService, ThreadPool threadPool, MetaDataCreateIndexService createIndexService, ActionFilters actionFilters, IndexNameExpressionResolver indexNameExpressionResolver) {
