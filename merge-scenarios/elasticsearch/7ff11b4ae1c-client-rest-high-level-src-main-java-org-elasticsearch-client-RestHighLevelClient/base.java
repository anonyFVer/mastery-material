...
public class RestHighLevelClient implements Closeable {
    ...
    public final void updateByQueryAsync(UpdateByQueryRequest reindexRequest, RequestOptions options, ActionListener<BulkByScrollResponse> listener) {
        performRequestAsyncAndParseEntity(reindexRequest, RequestConverters::updateByQuery, options, BulkByScrollResponse::fromXContent, listener, emptySet());
    }
    ...
    public final void deleteByQueryAsync(DeleteByQueryRequest reindexRequest, RequestOptions options, ActionListener<BulkByScrollResponse> listener) {
        performRequestAsyncAndParseEntity(reindexRequest, RequestConverters::deleteByQuery, options, BulkByScrollResponse::fromXContent, listener, emptySet());
    }
