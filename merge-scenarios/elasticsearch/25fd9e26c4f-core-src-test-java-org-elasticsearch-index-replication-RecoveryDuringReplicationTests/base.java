...
public class RecoveryDuringReplicationTests extends ESIndexLevelReplicationTestCase {
    ...
    private static class BlockingTarget extends RecoveryTarget {
        ...
        BlockingTarget(RecoveryState.Stage stageToBlock, CountDownLatch recoveryBlocked, CountDownLatch releaseRecovery, IndexShard shard, DiscoveryNode sourceNode, RecoveryTargetService.RecoveryListener listener, ESLogger logger) {
