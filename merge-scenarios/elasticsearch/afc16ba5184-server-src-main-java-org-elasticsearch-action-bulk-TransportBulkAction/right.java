    ...
    static final class BulkRequestModifier implements Iterator<DocWriteRequest<?>> {
        ...
        BulkRequest getBulkRequest() {
            if (itemResponses.isEmpty()) {
                ...
                originalSlots = new int[requests.size()];
        ...
        void markCurrentItemAsDropped() {
            ...
            itemResponses.add(new BulkItemResponse(currentSlot, indexRequest.opType(), new UpdateResponse(new ShardId(indexRequest.index(), IndexMetaData.INDEX_UUID_NA_VALUE, 0), indexRequest.type(), id, SequenceNumbers.UNASSIGNED_SEQ_NO, SequenceNumbers.UNASSIGNED_PRIMARY_TERM, indexRequest.version(), DocWriteResponse.Result.NOOP)));
        }
