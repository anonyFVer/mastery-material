...
public class FullClusterRestartIT extends ESRestTestCase {
    ...
    public void testSqlFailsOnIndexWithTwoTypes() throws IOException {
        ...
        ResponseException e = expectThrows(ResponseException.class, () -> client().performRequest("POST", "/_sql", emptyMap(), new StringEntity("{\"query\":\"SELECT * FROM testsqlfailsonindexwithtwotypes\"}", ContentType.APPLICATION_JSON)));
