...
//            boolean isOverride = declaredFunction.getModifiers().isOverride();
            for (JetType supertype : classDescriptor.getTypeConstructor().getSupertypes()) {
                ...
                if (overridden != null) {
//                    if (isOverride && overridden.getModifiers()!= null && !overridden.getModifiers().isOverridable()) {
...
//            if (declaredFunction.getModifiers().isOverride() && declaredFunction.getOverriddenFunctions().size() == 0) {
//                trace.getErrorHandler().genericError(function.getModifierList().getModifierNode(JetTokens.OVERRIDE_KEYWORD),
//                                                     "Method " + declaredFunction.getName() + " overrides nothing");
//            }
//            if (!declaredFunction.getModifiers().isOverride() && declaredFunction.getOverriddenFunctions().size() > 0) {
//                FunctionDescriptor overriddenMethod = declaredFunction.getOverriddenFunctions().iterator().next();
