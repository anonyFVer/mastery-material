...
public class SpdyFrameEncoder extends OneToOneEncoder {
    ...
    protected Object encode(ChannelHandlerContext ctx, Channel channel, Object msg) throws Exception {
        if (msg instanceof SpdyDataFrame) {
            ...
            ChannelBuffer data = compressHeaderBlock(encodeHeaderBlock(spdySynStreamFrame));
            ...
            ChannelBuffer data = compressHeaderBlock(encodeHeaderBlock(spdySynReplyFrame));
            ...
            ChannelBuffer data = compressHeaderBlock(encodeHeaderBlock(spdyHeadersFrame));
            int headerBlockLength = data.readableBytes();
