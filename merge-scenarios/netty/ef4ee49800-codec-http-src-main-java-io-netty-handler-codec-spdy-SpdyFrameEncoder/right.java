...
public class SpdyFrameEncoder extends OneToOneEncoder {
    ...
    public SpdyFrameEncoder(int version, int compressionLevel, int windowBits, int memLevel) {
        ...
        headerBlockCompressor = SpdyHeaderBlockCompressor.newInstance(version, compressionLevel, windowBits, memLevel);
    }
    ...
    protected Object encode(ChannelHandlerContext ctx, Channel channel, Object msg) throws Exception {
        if (msg instanceof SpdyDataFrame) {
            ...
            ChannelBuffer data = compressHeaderBlock(encodeHeaderBlock(version, spdySynStreamFrame));
            ...
            ChannelBuffer data = compressHeaderBlock(encodeHeaderBlock(version, spdySynReplyFrame));
            ...
            ChannelBuffer frame = ChannelBuffers.buffer(ByteOrder.BIG_ENDIAN, SPDY_HEADER_SIZE + 8);
            frame.writeShort(version | 0x8000);
            ...
            ChannelBuffer frame = ChannelBuffers.buffer(ByteOrder.BIG_ENDIAN, SPDY_HEADER_SIZE);
            frame.writeShort(version | 0x8000);
            ...
            ChannelBuffer data = compressHeaderBlock(encodeHeaderBlock(version, spdyHeadersFrame));
