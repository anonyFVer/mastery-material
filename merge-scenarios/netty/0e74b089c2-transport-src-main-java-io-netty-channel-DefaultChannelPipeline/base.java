...
public class DefaultChannelPipeline implements ChannelPipeline {
    ...
    public synchronized ChannelPipeline addFirst(EventExecutor executor, String name, ChannelHandler handler) {
        ...
        DefaultChannelHandlerContext newCtx = new DefaultChannelHandlerContext(this, executor, head, nextCtx, name, handler);
    ...
    public synchronized ChannelPipeline addLast(EventExecutor executor, String name, ChannelHandler handler) {
        ...
        DefaultChannelHandlerContext newTail = new DefaultChannelHandlerContext(this, executor, oldTail, null, name, handler);
    ...
    public synchronized ChannelPipeline addBefore(EventExecutor executor, String baseName, String name, ChannelHandler handler) {
        ...
        checkDuplicateName(name);
        DefaultChannelHandlerContext newCtx = new DefaultChannelHandlerContext(this, executor, ctx.prev, ctx, name, handler);
        callBeforeAdd(newCtx);
    ...
    public synchronized ChannelPipeline addAfter(EventExecutor executor, String baseName, String name, ChannelHandler handler) {
        ...
        if (ctx == tail) {
            ...
            checkDuplicateName(name);
            DefaultChannelHandlerContext newCtx = new DefaultChannelHandlerContext(this, executor, ctx, ctx.next, name, handler);
            callBeforeAdd(newCtx);
    ...
    private ChannelHandler replace(DefaultChannelHandlerContext ctx, String newName, ChannelHandler newHandler) {
        if (ctx == head) {
            ...
            DefaultChannelHandlerContext prev = ctx.prev;
            DefaultChannelHandlerContext next = ctx.next;
            DefaultChannelHandlerContext newCtx = new DefaultChannelHandlerContext(this, ctx.executor, prev, next, newName, newHandler);
            callBeforeRemove(ctx);
            callBeforeAdd(newCtx);
            prev.next = newCtx;
            next.prev = newCtx;
