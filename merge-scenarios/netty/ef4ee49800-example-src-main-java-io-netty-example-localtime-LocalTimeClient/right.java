...
public class LocalTimeClient {
    ...
    private static final InternalLogger logger = InternalLoggerFactory.getInstance(LocalTimeClient.class);
    ...
    private static void printUsage() {
        logger.error("Usage: " + LocalTimeClient.class.getSimpleName() + " <host> <port> <continent/city_name> ...");
        logger.error("Example: " + LocalTimeClient.class.getSimpleName() + " localhost 8080 America/New_York Asia/Seoul");
    }
