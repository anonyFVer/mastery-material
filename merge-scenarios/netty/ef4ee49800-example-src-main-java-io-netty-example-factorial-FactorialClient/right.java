...
public class FactorialClient {
    ...
    private static final InternalLogger logger = InternalLoggerFactory.getInstance(FactorialClient.class);
    ...
    public static void main(String[] args) throws Exception {
        if (args.length != 3) {
            logger.error("Usage: " + FactorialClient.class.getSimpleName() + " <host> <port> <count>");
            return;
        }
        String host = args[0];
