...
public class SecureChatClient {
    ...
    private static final InternalLogger logger = InternalLoggerFactory.getInstance(SecureChatClient.class);
    ...
    public static void main(String[] args) throws Exception {
        if (args.length != 2) {
            logger.error("Usage: " + SecureChatClient.class.getSimpleName() + " <host> <port>");
            return;
        }
        String host = args[0];
