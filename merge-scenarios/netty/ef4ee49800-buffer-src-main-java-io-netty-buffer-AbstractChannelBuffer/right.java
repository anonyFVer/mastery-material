...
public abstract class AbstractChannelBuffer implements ChannelBuffer {
    ...
    public void setIndex(int readerIndex, int writerIndex) {
        if (readerIndex < 0 || readerIndex > writerIndex || writerIndex > capacity()) {
            throw new IndexOutOfBoundsException("Invalid indexes: readerIndex is " + readerIndex + ", writerIndex is " + writerIndex + ", capacity is " + capacity());
        }
        this.readerIndex = readerIndex;
        this.writerIndex = writerIndex;
    }
    ...
    public void skipBytes(int length) {
        ...
        if (newReaderIndex > writerIndex) {
            throw new IndexOutOfBoundsException("Readable bytes exceeded - Need " + newReaderIndex + ", maximum is " + writerIndex);
        }
