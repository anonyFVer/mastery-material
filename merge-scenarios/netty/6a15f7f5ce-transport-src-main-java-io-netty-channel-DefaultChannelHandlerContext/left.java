...
final class DefaultChannelHandlerContext extends DefaultAttributeMap implements ChannelHandlerContext {
    ...
    private final Runnable nextCtxFireInboundBufferUpdatedTask = new Runnable() {
        ...
        @Override
        public void run() {
            DefaultChannelHandlerContext next = nextContext(DefaultChannelHandlerContext.this.next, DIR_INBOUND);
            if (next != null) {
                next.fillBridge();
    ...
    DefaultChannelHandlerContext(DefaultChannelPipeline pipeline, EventExecutor executor, DefaultChannelHandlerContext prev, DefaultChannelHandlerContext next, String name, ChannelHandler handler) {
        if (name == null) {
