...
public class ThriftCodecTest {
    ...
    public void testDecodeRequest() throws Exception {
        ...
        protocol.writeI16(Short.MAX_VALUE);
        protocol.writeByte(ThriftCodec.VERSION);
        protocol.writeString((String) ((RpcInvocation) request.getData()).getAttachment(Constants.INTERFACE_KEY));
        protocol.writeString((String) ((RpcInvocation) request.getData()).getAttachment(Constants.PATH_KEY));
        protocol.writeI64(request.getId());
        protocol.getTransport().flush();
        headerLength = bos.size();
        Demo.echoString_args args = new Demo.echoString_args();
