...
public class ZookeeperMetadataReport extends AbstractMetadataReport {
    ...
    String toCategoryPath(URL url) {
        ...
        return toServicePath(url) + Constants.PATH_SEPARATOR + TAG + Constants.PATH_SEPARATOR + (version == null ? "" : (version + Constants.PATH_SEPARATOR)) + (protocol != null ? protocol : url.getProtocol()) + appStr;
    }
