...
public class GenericImplFilter extends ListenableFilter {
    ...
    public Result invoke(Invoker<?> invoker, Invocation invocation) throws RpcException {
        ...
        if (ProtocolUtils.isGeneric(generic) && (!$INVOKE.equals(invocation.getMethodName()) && !$INVOKE_ASYNC.equals(invocation.getMethodName())) && invocation instanceof RpcInvocation) {
        ...
        } else if ((invocation.getMethodName().equals($INVOKE) || invocation.getMethodName().equals($INVOKE_ASYNC)) && invocation.getArguments() != null && invocation.getArguments().length == 3 && ProtocolUtils.isGeneric(generic)) {
    ...
    static class GenericImplListener implements Listener {
        ...
        public void onResponse(Result appResponse, Invoker<?> invoker, Invocation invocation) {
            ...
            if (ProtocolUtils.isGeneric(generic) && GenericService.class != invoker.getInterface() && (!$INVOKE.equals(invocation.getMethodName()) && !$INVOKE_ASYNC.equals(invocation.getMethodName())) && invocation instanceof RpcInvocation) {
