...
public class JavaBeanSerializeUtilTest {
    ...
    public void testSetEnumNameProperty() {
        ...
        JavaBeanDescriptor descriptor = new JavaBeanDescriptor(JavaBeanDescriptor.class.getName(), JavaBeanDescriptor.TYPE_ENUM);
    ...
    public void testSetClassNameProperty() {
        ...
        JavaBeanDescriptor descriptor = new JavaBeanDescriptor(JavaBeanDescriptor.class.getName(), JavaBeanDescriptor.TYPE_CLASS);
