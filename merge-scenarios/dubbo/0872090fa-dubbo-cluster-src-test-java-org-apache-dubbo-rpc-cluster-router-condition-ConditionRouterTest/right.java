...
public class ConditionRouterTest {
    ...
    public void testRoute_matchFilter() {
        ...
        Invoker<String> invoker1 = new MockInvoker<String>(URL.valueOf("dubbo://10.10.3.3:20880/com.foo.BarService?default.serialization=fastjson"));
        ...
        Router router1 = new ConditionRouterFactory().getRouter(getRouteUrl("host = " + NetUtils.getLocalHost() + " => " + " host = 10.10.3.3").addParameter(FORCE_KEY, String.valueOf(true)));
        Router router2 = new ConditionRouterFactory().getRouter(getRouteUrl("host = " + NetUtils.getLocalHost() + " => " + " host = 10.10.3.* & host != 10.10.3.3").addParameter(FORCE_KEY, String.valueOf(true)));
        Router router3 = new ConditionRouterFactory().getRouter(getRouteUrl("host = " + NetUtils.getLocalHost() + " => " + " host = 10.10.3.3  & host != 10.10.3.3").addParameter(FORCE_KEY, String.valueOf(true)));
        Router router4 = new ConditionRouterFactory().getRouter(getRouteUrl("host = " + NetUtils.getLocalHost() + " => " + " host = 10.10.3.2,10.10.3.3,10.10.3.4").addParameter(FORCE_KEY, String.valueOf(true)));
        Router router5 = new ConditionRouterFactory().getRouter(getRouteUrl("host = " + NetUtils.getLocalHost() + " => " + " host != 10.10.3.3").addParameter(FORCE_KEY, String.valueOf(true)));
    ...
    public void testRoute_methodRoute() {
        ...
        invokers.add(invoker2);
        invokers.add(invoker3);
        Router router4 = new ConditionRouterFactory().getRouter(getRouteUrl("host = " + NetUtils.getLocalHost() + " & methods = getFoo => " + " host = 10.10.3.3").addParameter(FORCE_KEY, String.valueOf(true)));
        ...
        Assertions.assertEquals(1, filteredInvokers1.size());
        Router router5 = new ConditionRouterFactory().getRouter(getRouteUrl("host = " + NetUtils.getLocalHost() + " & methods = unvalidmethod => " + " host = 10.10.3.3").addParameter(FORCE_KEY, String.valueOf(true)));
