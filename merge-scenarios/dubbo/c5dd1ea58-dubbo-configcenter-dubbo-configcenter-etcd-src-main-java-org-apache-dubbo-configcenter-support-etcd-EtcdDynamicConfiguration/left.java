    ...
    public class EtcdConfigWatcher implements StreamObserver<WatchResponse> {
        ...
        public void onNext(WatchResponse watchResponse) {
            ...
            for (Event etcdEvent : watchResponse.getEventsList()) {
                ...
                ConfigChangeEvent event = new ConfigChangeEvent(etcdEvent.getKv().getKey().toString(UTF_8), etcdEvent.getKv().getValue().toString(UTF_8), type);
        ...
        private void watch() {
            ...
            WatchCreateRequest.Builder builder = WatchCreateRequest.newBuilder().setKey(ByteString.copyFromUtf8(key)).setProgressNotify(true);
