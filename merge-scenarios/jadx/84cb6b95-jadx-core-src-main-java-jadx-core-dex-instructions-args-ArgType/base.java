...
public abstract class ArgType {
    ...
    private static final class WildcardType extends ObjectType {
        ...
        @Override
        boolean internalEquals(Object obj) {
            return super.internalEquals(obj) && bounds == ((WildcardType) obj).bounds && type.equals(((WildcardType) obj).type);
        }
    ...
    private static class GenericObject extends ObjectType {
        ...
        public GenericObject(GenericObject outerType, String innerName, ArgType[] generics) {
            ...
            this.generics = generics;
            this.hash = outerType.hashCode() + 31 * innerName.hashCode() + 31 * 31 * Arrays.hashCode(generics);
        }
        ...
        @Override
        boolean internalEquals(Object obj) {
            return super.internalEquals(obj) && Arrays.equals(generics, ((GenericObject) obj).generics);
        }
