...
public class RequestManagerTest {
    ...
    public void setUp() {
        ...
        when(factory.build(any(Context.class), any(ConnectivityMonitor.ConnectivityListener.class))).thenAnswer(new Answer<ConnectivityMonitor>() {
        ...
        manager = new RequestManager(Robolectric.application, lifecycle, treeNode, requestTracker, factory);
    ...
    public void testAppliesDefaultOptionsWhenUsingGenericModelLoaderAndDataClass() {
        ...
        GenericTranscodeRequest<Float, InputStream, Bitmap> builder = manager.using(modelLoader, InputStream.class).load(model).as(Bitmap.class);
    ...
    public void testAppliesDefaultOptionsWhenUsingImageStreamModelLoader() {
        ...
        DrawableTypeRequest<String> builder = manager.using(modelLoader).load(model);
        verify(options).apply(eq(builder));
    }
    ...
    public void testAppliesDefaultOptionsWhenUsingByteArrayLoader() {
        ...
        DrawableTypeRequest<byte[]> builder = manager.using(loader).load(model);
        verify(options).apply(eq(builder));
    }
