...
public abstract class Downsampler implements BitmapDecoder<InputStream> {
    ...
    @Override
    public Bitmap decode(InputStream is, BitmapPool pool, int outWidth, int outHeight, Map<String, Object> options) {
        ...
        try {
            ...
            DecodeFormat decodeFormat = options.containsKey(KEY_DECODE_FORMAT) ? (DecodeFormat) options.get(KEY_DECODE_FORMAT) : DecodeFormat.DEFAULT;
            final Bitmap downsampled = downsampleWithSize(invalidatingStream, bufferedStream, bitmapFactoryOptions, pool, inWidth, inHeight, sampleSize, decodeFormat);
