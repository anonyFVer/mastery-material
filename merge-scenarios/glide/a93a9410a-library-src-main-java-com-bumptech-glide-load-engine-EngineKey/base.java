...
class EngineKey implements Key {
    ...
    public String toString() {
        if (stringKey == null) {
            stringKey = new StringBuilder().append(id).append(signature).append(width).append(height).append(cacheDecoder != null ? cacheDecoder.getId() : "").append(decoder != null ? decoder.getId() : "").append(transformation != null ? transformation.getId() : "").append(encoder != null ? encoder.getId() : "").append(transcoder != null ? transcoder.getId() : "").append(sourceEncoder != null ? sourceEncoder.getId() : "").toString();
        }
        return stringKey;
    }
