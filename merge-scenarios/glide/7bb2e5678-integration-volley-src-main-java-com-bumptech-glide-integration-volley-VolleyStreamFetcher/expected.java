...
public class VolleyStreamFetcher implements DataFetcher<InputStream> {
    ...
    public static final VolleyRequestFactory DEFAULT_REQUEST_FACTORY = new VolleyRequestFactory() {
        ...
        @Override
        public Request<byte[]> create(String url, VolleyRequestFuture<InputStream> future, Request.Priority priority) {
    ...
    public InputStream loadData(Priority priority) throws Exception {
        ...
        Request<byte[]> request = requestFactory.create(stringUrl, requestFuture, glideToVolleyPriority(priority));
