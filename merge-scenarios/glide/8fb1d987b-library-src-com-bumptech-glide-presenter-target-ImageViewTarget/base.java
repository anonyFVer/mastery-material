...
public class ImageViewTarget implements Target {
    ...
    private static class SizeDeterminer {
        ...
        private boolean isHandled(LayoutParams layoutParams) {
            return layoutParams != null && ((layoutParams.width > 0 && layoutParams.height > 0) || (layoutParams.width == LayoutParams.WRAP_CONTENT || layoutParams.height == LayoutParams.WRAP_CONTENT));
        }
    }
}