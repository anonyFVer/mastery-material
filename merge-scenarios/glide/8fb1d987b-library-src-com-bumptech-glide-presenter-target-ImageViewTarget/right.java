...
public class ImageViewTarget implements Target {
    ...
    private static class SizeDeterminer {
        ...
        public void getSize(SizeReadyCallback cb) {
            ...
            if (isViewSizeValid()) {
                ...
                if (Log.isLoggable(TAG, Log.WARN)) {
                    Log.w(TAG, "Trying to load image into ImageView using WRAP_CONTENT, defaulting to screen" + " dimensions: [" + width + "x" + height + "]. Give the view an actual width and height " + " for better performance.");
                }
        ...
        private boolean isUsingWrapContent() {
            ...
            return layoutParams != null && (layoutParams.width == LayoutParams.WRAP_CONTENT || layoutParams.height == LayoutParams.WRAP_CONTENT);
        }
