...
public final class TransformationUtils {
    ...
    private static final Lock BITMAP_DRAWABLE_LOCK = "XT1097".equals(Build.MODEL) && Build.VERSION.SDK_INT == Build.VERSION_CODES.LOLLIPOP_MR1 ? new ReentrantLock() : new NoLock();
