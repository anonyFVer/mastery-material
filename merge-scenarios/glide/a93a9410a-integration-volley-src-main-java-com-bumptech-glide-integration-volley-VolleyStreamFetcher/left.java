...
public class VolleyStreamFetcher implements DataFetcher<InputStream> {
    ...
    public InputStream loadData(Priority priority) throws Exception {
        ...
        Request<byte[]> request = requestFactory.create(stringUrl, requestFuture, glideToVolleyPriority(priority), url.getHeaders());
    ...
    private static class GlideRequest extends Request<byte[]> {
        ...
        public GlideRequest(String url, VolleyRequestFuture<InputStream> future, Priority priority, Map<String, String> headers) {
