    ...
    public void preFill(PreFillType.Builder... bitmapAttributeBuilders) {
        ...
        for (int i = 0; i < bitmapAttributeBuilders.length; i++) {
            ...
            if (builder.getConfig() == null) {
                builder.setConfig(defaultFormat == DecodeFormat.ALWAYS_ARGB_8888 || defaultFormat == DecodeFormat.PREFER_ARGB_8888 ? Bitmap.Config.ARGB_8888 : Bitmap.Config.RGB_565);
            }
