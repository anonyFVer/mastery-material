...
public abstract class RealmBaseDataSet<T extends RealmObject, S extends Entry> extends BaseDataSet<S> {
    ...
    public S buildEntryFromResultObject(T realmObject, int xIndex) {
        ...
        return (S) new Entry(dynamicObject.getFloat(mValuesField), mIndexField == null ? xIndex : dynamicObject.getInt(mIndexField));
    }
    ...
    public List<S> getEntriesForXIndex(int xIndex) {
        ...
        if (mIndexField == null) {
            ...
            for (T e : foundObjects) entries.add(buildEntryFromResultObject(e, xIndex));
        }
        return entries;
    }
    ...
    public float[] getYValsForXIndex(int xIndex) {
        ...
        int i = 0;
        for (S e : entries) yVals[i++] = e.getVal();
        return yVals;
    }
